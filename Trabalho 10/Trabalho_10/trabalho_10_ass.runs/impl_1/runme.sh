...
HD_PWD='C:/Users/user/Documents/PED/trabalho_10_ass/trabalho_10_ass.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MAXTER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MAXTER.tcl -notrace
