...
HD_PWD='C:/Users/user/Documents/PED/trabalho_10_ass/trabalho_10_ass.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAXTER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MAXTER.tcl
