...
HD_PWD='C:/Users/user/Documents/PED/Trabalho_9/Trabalho_9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log maps.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source maps.tcl -notrace
