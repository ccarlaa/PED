...
HD_PWD='C:/Users/user/Documents/PED/Trabalho_9/Trabalho_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maps.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maps.tcl
